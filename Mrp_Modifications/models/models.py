...
class MrpBom(models.Model):
    ...
    ratio = fields.Float(string="L.R", default=1.0, required=True)
    grey_weight = fields.Char(string="Grey Weight")
    grey_product_tmpl_id = fields.Many2one(
        'product.template', 'Greige Product',
    ...
    material_type = fields.Selection([
        ...
        ('dyed fabric', 'Dyed Fabric')], 'Type', required=True)
